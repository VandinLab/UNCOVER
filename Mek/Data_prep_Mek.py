...
input_file2 = open('/Users/Rebecca/Dropbox/Vandin_Sarto_Project/Raw_Data/MEK_inhibitor_profile2.txt', 'r')


data1 = pd.read_csv('/Users/Rebecca/Dropbox/Vandin_Sarto_Project/Raw_Data/MEK_inhibitor_profile2.txt', delimiter="\t", index_col='Description')
...
result1 = result1[((result1.column_sum < 101) & (result1.column_sum  > 2)) | (result1.index == "PD-0325901")]
...
result2.to_csv('/Users/Rebecca/Dropbox/Vandin_Sarto_Project/MekData.txt', sep=' ')
